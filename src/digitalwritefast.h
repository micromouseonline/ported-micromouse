/*
  ...
  PH 2017: NOTE that these generate single instruction writes and that, I think, pins should
  have a few cycles to settle. Two consecutive writes seem to give results that are, at best
  inconsistent and may leave pins in the wrong state.
 */
